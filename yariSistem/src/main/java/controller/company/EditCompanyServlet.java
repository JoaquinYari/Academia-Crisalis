...
public class EditCompanyServlet extends HttpServlet implements Servlet {

	private static final long serialVersionUID = -6410190087479523292L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		if (company.isValid()) {
			...
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/views/customer/editCompany.jsp");
			dispatcher.forward(req, resp);
		}
	}
}
